...
def nl_west_qualified_pitchers():
    ...
    for i in dates:
        ...
        try:
            ...
            print("Inserted qualified pitchers for NL West " + endDate)

        except AttributeError:
            print("No qualified pitchers for " + endDate)
            continue

    qualified_pitchers.to_csv('nl-west-qualified-pitchers.csv')

def nl_central_qualified_pitchers():
    ...
    for i in dates:
        ...
        try:
            ...
            df['Date'] = (unformat_endDate + datetime.timedelta(days=1)).strftime("%Y-%m-%d")
            qualified_pitchers = qualified_pitchers.append(df)
            print("Inserted qualified pitchers for NL Central " + endDate)

        except AttributeError:
            print("No qualified pitchers for " + endDate)
            continue

    qualified_pitchers.to_csv('nl-central-qualified-pitchers.csv')

def nl_east_qualified_pitchers():
    ...
    for i in dates:
        ...
        try:
            ...
            df['Date'] = (unformat_endDate + datetime.timedelta(days=1)).strftime("%Y-%m-%d")
            qualified_pitchers = qualified_pitchers.append(df)
            print("Inserted qualified pitchers for NL East " + endDate)

        except AttributeError:
            print("No qualified pitchers for " + endDate)
            continue

    qualified_pitchers.to_csv('nl-east-qualified-pitchers.csv')

# Run Functions
nl_west_qualified_pitchers()
nl_central_qualified_pitchers()
nl_east_qualified_pitchers()
