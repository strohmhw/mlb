...
def relief_individual():

    relief-individual-dataset = pd.DataFrame()
    ...
    for i in dates:
        ...
        try:
            # Load URL, Scrap URL
            print("Loading Relief Individual URL...")
            ...
            relief-individual-dataset = relief-individual-dataset.append(df)
            print("Inserted relief individual for " + endDate)

        except AttributeError:
            print("No relief individual for " + endDate)
            continue

    relief-individual-dataset.to_csv('relief-individual-dataset.csv')
